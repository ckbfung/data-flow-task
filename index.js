...
var dataSources = {
    'MS SQL Source': {
        DB: 'MSSQL',
        ConnectionString: "Data Source=localhost\\SQL2014;Initial Catalog=QRSNet;Integrated Security=True"
    },
    'MS SQL Dest': {
        DB: 'MSSQL',
        ConnectionString: "Data Source=localhost\\SQL2014;Initial Catalog=QRSNet;Integrated Security=True"
...
var dataFlow = {
    Cleanup: {
		...
		Queries: [
            'DELETE FROM fok',
            "insert into fok(a,b,c,d) values(10,'10',SYSDATETIME(),SYSDATETIME())",
            "insert into fok(a,b,c,d) values(20,'20',SYSDATETIME(),SYSDATETIME())",
            "insert into fok(a,b,c,d) values(30,'30',SYSDATETIME(),SYSDATETIME())",
            "insert into fok(a,b,c,d) values(null,'10',SYSDATETIME(),SYSDATETIME())",
            "insert into fok(a,b,c,d) values(10,null,SYSDATETIME(),SYSDATETIME())",
            "insert into fok(a,b,c,d) values(20,'20',null,SYSDATETIME())",
            "insert into fok(a,b,c,d) values(20,'20',SYSDATETIME(),null)"
        ],
	},
	CopyTable: {
	...
	InsertData: [
		{
			...
			DbSource: {
				Name: 'MS SQL Source',
				Query: 'Select a as COL1, b as COL2 from fok where a = ${Param.ID}'
			},
			Transforms: ['t1', 't3', 't2'],
			DbDestination: {
				Name: 'MS SQL Dest',
				Queries: [
                    "Insert Into fok (a, b) Values(${Row.COL1}, '${Row.COL2}')"
                ]
			}
		},
		{
...
function t1(row, context, callback) {
    row.COL1 = 1000
    console.log('Call t1')
    console.dir(context)
    context['Row'] = row
...
function t2(row, context, callback) {
    row.COL2 = ''
    console.log('Call t2')
    console.dir(context)
    callback()
}
function t3(row, context, callback) {
    row.COL2 = 'Test'
    console.log('Call t3')
    console.dir(context)
    callback()
}
function t4(row, context, callback) {
    row[2] = 'Row:' + row[2]
    console.log('Call t4')
    console.dir(context)
    callback()
...
var dft = DataFlowTask(dataSources, dataFlow)
dft.on('Message', function(msg) {
    console.log('Message:', msg)
})
dft.on('Query', function(msg) {
    console.log('Query:', msg)
})
dft.Start({ ID: 10 }, [t1, t2, t3, t4],  function(err) {
